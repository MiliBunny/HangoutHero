class UserPreferencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_preference.save
        format.html { redirect_to user_preference_url(@user_preference), notice: "User preference was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user_preference.update(user_preference_params)
        format.html { redirect_to user_preference_url(@user_preference), notice: "User preference was successfully updated." }
  ...
  private
    ...
    def user_preference_params
      params.require(:user_preference).permit(:vehicle, :price, :cuisine, :dietary_restrictions, :entertainment_type, :physical_activity, :shopping_venue)
    end
end
